...
public class CaculatorActivity extends ActionBarActivity {
    ...
    int num1, num2, num3, num4, num5, num6, num7, num8, num9, num10, num11, num12, num13, num14, num15, num16 = 0;
        ...
        View.OnClickListener clisten = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "시험 보지 않은 과목엔 0을 입력해 주세요!", Toast.LENGTH_LONG).show();
                }
