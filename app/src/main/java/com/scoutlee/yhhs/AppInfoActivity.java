    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int arg0) {
            ...
            switch (arg0) {
                ...
                /** tab1 is selected */
                case 0:
                    Appinfo1 appinfo1 = new Appinfo1();
                    return appinfo1;
                case 1:
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.title_activity_appinfo1).toUpperCase();
                case 1:
                    return getString(R.string.title_activity_appinfo2).toUpperCase();
                case 2:
                    return getString(R.string.title_activity_appinfo3).toUpperCase();
