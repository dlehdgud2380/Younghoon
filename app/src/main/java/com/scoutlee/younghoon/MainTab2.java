...
public class MainTab2 extends Fragment implements OnClickListener {

    Context mContext;

    public MainTab2(Context context) {
        mContext = context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.maintab2, null);
        ...
        try {
            if (resName.equals("")) {
                ...
                id = getResources().getIdentifier(name, "drawable", "com.scoutlee.younghoon");
